...
| `kotlin`       | `kotlin`         | [`ht-sdks/events-sdk-kotlin`](https://github.com/ht-sdks/events-sdk-kotlin)                      | Later. JitPack-only (some consumers cannot use JitPack). Not the Java Android SDK. `screen`, not `page`.                                                                                                                      |
